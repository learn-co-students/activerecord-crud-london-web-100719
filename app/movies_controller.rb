...
def can_be_found_updated_and_saved
  ...
  specific_movie = Movie.find_by(title: "Awesome Flick")
  specific_movie.update(title: "Even Awesomer Flick")
  specific_movie.save
end

def can_update_using_update_method
  Movie.create(title: "Wat?")
  specific_movie = Movie.find_by(title: "Wat?")
  specific_movie.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  specific_movie = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
